...
import time
import create_and_read_TFRecord2.reader2 as reader2
import os

X_train, y_train = reader2.get_file("/home/mqm/Workspace/DL/Datas/cat_vs_dog/train/train")
...
print("result:",per_class("/home/mqm/Workspace/DL/Datas/cat_vs_dog/train/train/dog/dog.14.jpg"))